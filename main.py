...
#from combo_box import ComboBox_Equation
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtCore import (QLocale, QPropertyAnimation, QDate, QDateTime, QMetaObject, QObject, QPoint, QRect, QSize, QTime, QUrl, Qt, QEvent)
from PyQt5.QtGui import (QBrush, QColor, QConicalGradient, QCursor, QFont, QFontDatabase, QIcon, QKeySequence, QLinearGradient, QPalette, QPainter, QPixmap, QRadialGradient)
from PyQt5.QtWidgets import *

from pyui.ui_function import *
from pyui.ui_main import Ui_MainWindow # MAINWINDOW CODE GENERATED BY THE QT DESIGNER AND PyQt5-uic.
from pyui.ui_dialog import Ui_Dialog # DIALOGBOX WINDOW GENERATED BY THE ABOVEW SAME
from pyui.ui_error import Ui_Error # ERRORBOX WINDOW GENERATED BY THE ABOVE SAME
 # A FILE WHERE ALL THE FUNCTION LIKE BUTTON PRESSES, SILDER, PROGRESS BAR E.T.C ARE DONE.
...
from actions.Connects import Action_for_sol
...
#--PAGE BBUG----------------------------------:
    #--CHANGING THE HEADING---------:
        ...
        self.combo = ComboBox_Equation()
        self.word = [0 for i in range(5)]
        self.ui.doc_but.clicked.connect(lambda : Action_for_sol.formulaToWord(self.word, self.ui))
        
        #def Equation_picture():
